        ...
        <div class="col-sm-7">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><input class="form-control" type="number" name='sz[<?=$ma_hh?>]' value="<?=$sz ?>" style="width:50px;" min="39" max="45"></td>
                    <td><input class="form-control" type="number" name='sl[<?=$ma_hh?>]' value="<?=$sl ?>" style="width:50px;" min="1"></td>
