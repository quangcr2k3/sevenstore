...
">
            ...
            ?>
                <div class="sanpham">
                    <a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>"><img src="../../sevenstore/css/admin/images/products/<?=$hinh?>" alt=""></a>
                    <div class="text">
                        <div class="price">
        ...
        <div class="row">
            <div class="container" style="margin-top: 50px;">
                <div class="row">
                    <div class="col-md-3">
                        <div class="fo">
                        <img src="../../sevenstore/css/danh-sach-sp/img/logooo.png" alt="" style ="width:60px;">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="fo">
