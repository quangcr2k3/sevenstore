...
">
    ...
    <?php
        require_once ('../../sevenstore/admin/dao/khach-hang.php');
    ...
    <div class="container" style="margin-top: 80px;">
        ...
        <input type="text" class="form-control" id="" name="ma_kh" value="<?=$ma_kh?>" hidden>
            ...
            <tr>
                <div class="form-group">
                <label for=""><b>Địa chỉ nhận hàng:</b></label>
                <textarea class="form-control" rows="2" id="" name = "dia_chi"></textarea>
                </div>
            </tr>
            <tr>
                <div class="form-group">
            ...
            <thead>
                ...
                <tr>
                    <td><b>Giao hàng</b></td>
                    <td style = "text-align:left;">Giao hàng miễn phí <br>
                    Ước tính cho Việt Nam</td>
                </tr>
                <tr>
                    <td><b>TỔNG</b></td>
                    <td style = "text-align:right;"><b><?=number_format($total)?> VNĐ</b></td>
                ...
                <tr>
                    <td colspan="2"><i>Quý khách vui lòng kiểm tra lại thông tin giao hàng và thông tin đơn hàng để tiến hành đặt hàng. Quý khách có thể tra cứu tình trạng đơn hàng tại sevenstore.com. Chúc quý khách ngày mới tốt lành !</i></td>
                </tr>
                <tr>
            ...
            <?php
                require_once ('../../sevenstore/admin/dao/hoa-don.php');
                ...
                try {
                    ...
                    // Câu SQL Insert
                    $sql = "INSERT INTO hoa_don(ngay_mua,dia_chi,ghi_chu,ma_kh) 
                            VALUES ('".$ngaymua."','".$dia_chi."','".$ghi_chu."','".$ma_kh."')";
                    ...
                    foreach($items as $item){
                        extract($item);
                        $sql = "INSERT INTO hoa_don_chi_tiet(ma_hd,ma_hh,size,so_luong,don_gia) VALUES ('".$ma_hd."','".$ma_hh."','".$sz."','".$sl."','".$price."')";
                        $conn->exec($sql);
