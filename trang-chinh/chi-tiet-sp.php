...
<head>
    ...
    <style>
        ...
        .soluong input[type="radio"] {
            display: none;
        }

        .soluong input[type="radio"]+label::before {
            content: '\25A0';
            /* Mã Unicode cho hình vuông */
            display: inline-block;
            font-size: 20px;
            width: 20px;
            height: 20px;
        ...
        .soluong input[type="radio"]:checked+label::before {
            background-color: #007BFF;
            /* Màu khi ô chọn được chọn */
            color: #fff;
        }
    </style>
</head>
        ...
        <div class="row">
            <div class="col-md-4" style="background-color: rgb(54, 54, 54);text-align: center">
                <div class="login">
                    ...
                    ?>
                        <a href="../../sevenstore/tai-khoan/dang-nhap.php">
                            <p><strong>ĐĂNG NHẬP / ĐĂNG KÍ</strong></p>
                        </a>
                    <?php } else { ?>
                        <a href="../../sevenstore/tai-khoan/thong-tin-tk.php">
 ...
 ============================================ -->
    ...
    <div class="container" style="margin-top: 80px;">
        <div class="row">
            ...
            <?php
            require_once('../../sevenstore/admin/dao/hang-hoa.php');
            extract($_REQUEST);
            ...
            <div class="col-md-4" style="padding-left: 0px">
                <div class="spchitiet">
                    <img src="../../sevenstore/css/admin/images/products/<?= $hinh ?>" alt="" style="width:100%;">
                </div>
            </div>
            <div class="col-md-5">
                <div class="thongtinsp">
                    <ul>
                        ...
                        <li style="margin-top: 15px; text-align:justify;"><?= $mo_ta ?></li>
                        ...
                        <li class="soluong1" style="margin-top: 27px;">
                            ...
                            if (!isset($_SESSION['user'])) {
                            ?>
                                <a href="../../sevenstore/tai-khoan/dang-nhap.php"><button style="margin-top:-5px;" class="btn btn-dark">ĐĂNG NHẬP ĐỂ MUA HÀNG</button></a>
                            <?php } else { ?>
            ...
            <div class="col-md-3">
                <div class="thanhtoan">
                    <div class="row">
                        ...
                        <ul>
                            <li> <img src="../../sevenstore/css/chi-tiet-sp/img/l2.png" alt=""> </li>
                            <li> <img src="../../sevenstore/css/chi-tiet-sp/img/l1.png" alt=""> </li><br>
                            <li> <img src="../../sevenstore/css/chi-tiet-sp/img/l4.png" alt=""> </li>

                            <li> <img src="../../sevenstore/css/chi-tiet-sp/img/l3.png" alt=""> </li>
                        </ul>
                    </div>
                    <div class="row">
                        <img src="../../sevenstore/css/chi-tiet-sp/img/list.png" alt="" style="width:100%">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12" style="padding-left: 0px;">
                ...
                <div class="owl-carousel owl-theme ">
                    ...
                    ?>
                        <div class="item">
                            <a href="chi-tiet-sp.php?ma_hh=<?= $ma_hh ?>"><img style="width: 200px" src="../../sevenstore/css/admin/images/products/<?= $hinh ?>" alt="ds"><span class='cung-loai'><?= $ten_loai ?></span></a>
                        </div>
                    <?php } ?>
                </div>
            </div>
