			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method = "post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter Address">
						<input class="input100" type="text" name="dia_chi" placeholder="Address" value ="<?=$sdt?>" readonly>
						<span class="focus-input100" data-placeholder="&#xf18e;"></span>
					</div>
					...
					<div class="text-center p-t-90">
						...
						<a class="txt1" href="../../sevenstore/tai-khoan/cap-nhat-tk.php">
							Cập nhật tài khoản ?
						</a> or
						<a class="txt1" href="../../sevenstore/tai-khoan/doi-mk.php">
							Đổi mật khẩu ?
						</a>
					</div>
				</form>
