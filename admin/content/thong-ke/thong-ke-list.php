...
<head>
  ...
  <script type="text/javascript">
    ...
    function drawChart() {
      ...
      var options = {
        title: "BIỂU ĐỒ THỐNG KÊ LOẠI HÀNG (theo số mẫu)",
        width: 1200,
        height: 500,
        bar: {groupWidth: "25%"},
        ...
        <div id="page-wrapper">
		  <div class="header"> 
                        <div class="page-header">
                            ...
                            <p>Dưới đây là những số liệu thống kê hàng hóa của SEVEN STORE hiện tại có trong kho: </p>
