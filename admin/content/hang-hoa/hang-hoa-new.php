...
<body>
            ...
            <div class="header">
                <div class="page-header">
                    ...
                    if (array_key_exists("btn_insert", $_REQUEST)) {
                        $up_hinh = save_file("hinh", "../../../../sevenstore/css/admin/images/products/");
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control-file border" name="hinh" id="hinh-input">
                        </div>
                        <img src="" alt="Hình ảnh" id="hinh-preview" style="max-width: 150px; max-height: 150px;">
                        ...
                        <div class="form-group">
                            ...
                            <select name="ma_loai" class="form-control">
                                ...
                                $loai_select_list = array_reverse($loai_select_list);
    ...
    document.getElementById("hinh-input").addEventListener("change", function () {
        // Lấy thẻ <img> để hiển thị hình ảnh
        var imgPreview = document.getElementById("hinh-preview");
